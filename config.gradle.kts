...
extra["branchConfigs"] = mapOf(
    "main" to mapOf(
        ...
        "versionCode" to 111,
        "versionName" to "1.1.8",
        "archivesBaseName" to "藥到叮嚀-v1.1.8"
    ),
    "beta" to mapOf(
        ...
        "versionCode" to 11,
        "versionName" to "0.1.8",
        "archivesBaseName" to "藥到叮嚀-v0.1.8-beta"
    ),
    "alpha" to mapOf(
        ...
        "enableLogging" to true,
        "versionCode" to 1,
        "versionName" to "0.0.8",
        "archivesBaseName" to "藥到叮嚀-v0.0.8-alpha"
    )
)